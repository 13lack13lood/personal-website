...
const About = () => {
	return (
		<AOSComponent>
			<div
				id="About"
				className="flex flex-col text-white min-h-screen justify-center text-lg w-2/3 backdrop-blur-xs mb-10 space-y-8 font-light"
			>
				<div
					className="text-3xl border-b-2 border-accent mb-5 text-center px-10 py-4 w-fit mx-auto font-bold drop-shadow-glowSmall"
					data-aos="flip-up"
					data-aos-delay="100"

...
const Contact = () => {
	...
	return (
		<AOSComponent>
			<div
				id="Contact"
				className="flex flex-col lg:flex-row items-center justify-evenly w-full p-10 lg:space-x-10 space-y-10 lg:space-y-0 min-h-screen my-5"
			>
				<div className="flex flex-col items-center justify-center space-y-16 w-full text-center lg:text-left lg:w-1/3 backdrop-blur-xs rounded-full">
					<div
						className="text-6xl text-accent dark:text-white drop-shadow-glowAccent dark:drop-shadow-glow w-full"
					...
					<div
						className="text-xl text-accent-light dark:text-white"
						data-aos-anchor="#Contact"
						data-aos="zoom-in-up"
						data-aos-delay="200"
					>
				...
				>
					<Form className="flex flex-col w-full lg:w-1/2 items-center justify-center space-y-7">
						<div

        ...
        <div className="p-4 w-full h-full border border-accent-light rounded-3xl backdrop-blur-xs bg-transparent shadow-glow group " data-aos="reveal" data-aos-delay={2 * index + 1 + "00"} id={"project" + index}>
            <div className="flex flex-col w-full h-full items-center justify-start p-6">
                ...
                <div className="flex flex-col h-full items-center">
                    <div className="text-white text-3xl font-semibold mb-4 w-full text-center border-b-2 border-accent-light pb-1" data-aos="fade-right" data-aos-delay={2 * index + 3 + "00"}>
                        {info.title}
                    </div>
                    <div className="flex flex-col justify-center text-white font-light grow" data-aos="zoom-in-up" data-aos-delay={2 * index + 4 + "00"}>
                        {info.desciption}
                    </div>

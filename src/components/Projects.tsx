...
const Projects = () => {
	return (
		<AOSComponent>
			<div
				id="Projects"
				className="flex flex-col items-center justify-between space-y-12 w-full min-h-screen p-20"
			>
				<div
					className="text-4xl border-b-2 border-accent text-white mb-5 text-center px-16 py-4 w-fit mx-auto font-bold drop-shadow-glowSmall"
					data-aos="flip-up"
				>
					Projects
				</div>

...
const ProjectDetails: { title: string; desciption: string; technologies: string[]; github: string }[] = [
    ...
    {
        title: "Clownsweeper",
        desciption: "A recreation and spin-off of the popular 2D game, Minesweeper, made in Java using OpenGL, LWJGL, and OpenAL.",
        technologies: ["Java", "OpenGL", "OpenAL", "LWJGL"],
        github: "https://github.com/13lack13lood/Clownsweeper",
    },
    {
        title: "Weather App",
        desciption: "A clean and sleek weather app designed with React featuring current weather and forcast as well as supporting city search.",
...
const Projects = () => {
    return (
        <AOSComponent>
            <div id="Projects" className="flex flex-col items-center justify-between space-y-12 w-full min-h-screen p-20">
                <div className="text-4xl border-b-2 border-accent text-accent dark:text-white mb-5 text-center px-16 py-4 w-fit mx-auto font-bold drop-shadow-glowSmall" data-aos="flip-up">
                    Projects
                </div>

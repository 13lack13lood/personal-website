...
const Socials = () => {
    return (
        <div className="border-t-2 border-accent w-2/3 flex flex-row justify-between items-center px-4 py-6 my-7">
            ...
            <div className="flex flex-row justify-center space-x-5">
                <a href="https://github.com/13lack13lood" target="_blank" className="transition-all duration-200 hover:scale-125">
                    <IconThemeSwitcher lighticon={GitHubLight} darkicon={GitHubDark} width={30} />
                </a>
                <a href="https://www.linkedin.com/in/harry-zhu-a2417326b/" target="_blank" className="transition-all duration-200 hover:scale-125">
                    <IconThemeSwitcher lighticon={linkedinLight} darkicon={linkedinDark} width={30} />
                </a>
                <a href="https://www.instagram.com/harryz409/" target="_blank" className="transition-all duration-200 hover:scale-125">
